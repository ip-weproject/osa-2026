...
const ContactForm = () => {
  ...
  const inputClasses = "w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-crypto-purple/50 focus:border-crypto-purple transition-all duration-300 backdrop-blur-sm";
        ...
        <div className="max-w-4xl mx-auto bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-8 md:p-12">
          ...
          {status === 'success' ? (
            <div className="flex flex-col items-center justify-center py-12 animate-fade-in space-y-4 bg-white/5 rounded-xl border border-white/5">
              ...
              <Button 
                variant="ghost" 
                className="text-crypto-purple hover:text-white mt-4"
            ...
            <form onSubmit={handleSubmit} className="max-w-xl mx-auto space-y-6 animate-fade-in" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="pt-4">
                <Button 
                  ...
                  className="w-full bg-crypto-purple hover:bg-crypto-dark-purple text-white py-6 text-lg transition-all duration-300 shadow-lg shadow-crypto-purple/20"
                >
                  {status === 'loading' ? (
                    <>
