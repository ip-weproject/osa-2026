  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-gradient-hero hero-glow">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 left-10 w-72 h-72 bg-osa-purple/10 rounded-full filter blur-3xl animate-pulse-slow"></div>
        <div className="absolute bottom-1/4 right-10 w-96 h-96 bg-osa-light-purple/10 rounded-full filter blur-3xl animate-pulse-slow" style={{ animationDelay: '1s' }}></div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 animate-fade-in-left">
            <div className="inline-flex items-center bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-4 py-1.5 mb-6">
              <span className="text-xs font-medium text-osa-purple mr-2">OSA</span>
              <span className="text-xs text-gray-300">Consulting Services</span>
              <ChevronRight className="h-4 w-4 text-gray-400 ml-1" />
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              <span className="text-gradient">Expertos en</span> Revenue Operations
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="bg-osa-purple hover:bg-osa-dark-purple text-white px-8 py-6">
                Hablemos
          ...
          <div className="lg:w-1/2 mt-12 lg:mt-0 animate-fade-in-right">
            <div className="relative max-w-md mx-auto animate-float">
              ...
              />
              <div className="absolute -right-6 -bottom-6 bg-osa-purple/20 backdrop-blur-md rounded-lg p-4 border border-osa-purple/30 shadow-lg">
              ...
              <div className="absolute -left-6 -top-6 bg-osa-purple/20 backdrop-blur-md rounded-lg p-4 border border-osa-purple/30 shadow-lg">
                <div className="flex items-center space-x-3">
                  <div className="h-10 w-10 bg-osa-purple/20 rounded-full flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-osa-purple" fill="none" viewBox="0 0 24 24" stroke="currentColor">
